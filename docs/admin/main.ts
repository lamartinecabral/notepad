...
namespace admin{
	...
	export var killOnAuthStateChanged = undefined;
	...
	export function listDocs(): Promise<void | Record<string,Doc>>{
	...
	export function getDoc(docId): Promise<Doc>{
	...
	export function clearDocs(func: (doc: Doc)=>boolean ){
